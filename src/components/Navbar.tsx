...
const Navbar: React.FC<NavbarProps> = ({ theme, toggleTheme }) => {
  ...
  const menuItems = [
    ...
    { id: 'mini-projects', label: 'Mini Projects', icon: Code },
    { id: 'projects', label: 'Major Projects', icon: Code },
        ...
        <div className="container mx-auto px-6">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="https://github.com/mohitsharma" target="_blank" rel="noopener noreferrer" className={`p-3 rounded-full bg-gradient-to-br from-gray-900 via-purple-600 to-cyan-400 shadow-lg animate-bounce-slow hover:scale-125 transition-all duration-300`} title="GitHub">
              ...
              <a href="mailto:msharmampr@gmail.com" className={`p-3 rounded-full bg-gradient-to-br from-pink-500 via-cyan-400 to-purple-600 shadow-lg animate-bounce-slow2 hover:scale-125 transition-all duration-300`} title="Mail">
                <Mail className="w-7 h-7 text-white" />
              </a>
              <a href="https://leetcode.com/yourleetcodeprofile" target="_blank" rel="noopener noreferrer" className={`p-3 rounded-full bg-gradient-to-br from-yellow-400 via-orange-500 to-yellow-700 shadow-lg animate-bounce-slow3 hover:scale-125 transition-all duration-300`} title="LeetCode">
